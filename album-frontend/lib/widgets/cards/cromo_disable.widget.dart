...
class CromoDisable extends StatefulWidget {
  double widthPorcent;
  ...
  @override
  State<CromoDisable> createState() => _CromoDisableState();
}

class _CromoDisableState extends State<CromoDisable> {
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text('', style: TextStyle(fontSize: w * 0.05),),
                              ),
                              Container(
                                padding: EdgeInsets.all(10),
                                alignment: Alignment.centerRight,
                                child: Text('', style: TextStyle(fontSize: w * 0.04), ),
                              ),
                            ],
                          ),
                        ),
